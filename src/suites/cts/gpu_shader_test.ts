...
type glslang = typeof import('@webgpu/glslang/web/glslang');
type Glslang = import('@webgpu/glslang/web/glslang').Glslang;
type ShaderStage = import('@webgpu/glslang/web/glslang').ShaderStage;
